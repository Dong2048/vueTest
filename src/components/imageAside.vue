<template>
    <el-aside widt="220px" class="image-aside" v-loading="loading">
        <div class="top">
           <AsideList :active="activeId==item.id" v-for="item,index in list" 
           :key="index" @edit="handleEdit(item)" @delete="handleDelete(item)" @click="handlechangeActiveId(item.id)">
            {{item.name}}
           </AsideList>
        </div>
        <div class="bottom">
    ...
    <FormDrawer :title="drawerTitle"  ref="formDrawerRef" @submit="handleSubmit">
        <el-form :model="form" ref="formRef" :rules="rules" label-width="80px" :inline="false">
            ...
            <el-form-item label="图库分类排序："  prop="order">
...
import {getImageClassList,createImageClass,updateImageClass,deleteImageClass} from '~/api/imageClass.js'
